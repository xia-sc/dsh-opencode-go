...
export class OpencodeGoAdapter extends LlmAdapter {
  ...
  async *stream(options) {
    ...
    if (endpoint === "responses") {
      yield* meteredStream(this.streamSurface(connection, headers, options, "/v1/responses", buildResponsesBody(options, images, cap), (body, signal, idleMs) => this.pumpResponses(body, signal, idleMs)), meta, record);
      ...
      yield* meteredStream(this.streamSurface(connection, msgHeaders, options, "/v1/messages", buildAnthropicBody(options, images, cap), (body, signal, idleMs) => this.pumpMessages(body, signal, idleMs)), meta, record);
    } else {
      yield* meteredStream(this.streamSurface(connection, headers, options, "/v1/chat/completions", buildChatBody(options, images, cap), (body, signal, idleMs) => this.pumpChunks(body, signal, idleMs)), meta, record);
    }
  }
